...
framee = inIframe();
if(url.indexOf("http://vmtech.into.hu/projekt/videoremote")>-1){
idje('install-button').className = 'letolt letoltve';
}
...
idje('videoremote0001a').innerHTML += '<div id="urlvideoremote001" style="display:none;">'+optionsUrl+'</div>';
